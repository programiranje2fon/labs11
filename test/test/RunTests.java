...
import problem1.TextFilesCheckTest;
import problem2.PersonTest;
import problem2.PersonsDatabaseTest;
...
public class RunTests {
	...
	public static void main(String[] args) {
		runTestsForClass(TextFilesCheckTest.class);
		runTestsForClass(PersonTest.class);
		runTestsForClass(PersonsDatabaseTest.class);
	}
